      ...
      <div class="card-block">
        <div class="row">
          <div class="col-md-12">
            ...
            <p>
              {if isset($order_customer.email)}
                {$axps_customer_email = $order_customer.email}
              {else}
                {$axps_customer_email = $customer.email}
              {/if}
              {l s='An email has been sent to your mail address %email%.' d='Shop.Theme.Checkout' sprintf=['%email%' => $axps_customer_email]}
...
{block name='page_content_container'}
  ...
  {if isset($registered_customer_exists)}
