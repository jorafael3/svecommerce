<div class="js-product item-inner 7">
        ...
        <div class="element-top">
            ...
            <div class="buttons-action axps-buttons-tootip-left">
                ...
                <a href="javascript:void(0)" class="btn-action quick-view js-quick-view" data-link-action="quickview"
                    title="{l s='Quick view' d='Shop.Theme.Actions'}" rel="nofollow">
                ...
                {if !$configuration.is_catalog && $product.add_to_cart_url && ($product.quantity > 0 || $product.allow_oosp)}
                    {if !$product.id_product_attribute}
                        ...
                        <div class="input-group input-group-add-cart bootstrap-touchspin">
                            ...
                            <input type="number" name="qty" value="{$product.minimal_quantity}"
                                class="js-number-qty form-control" data-min="{$product.minimal_quantity}">
                            <span class="input-group-btn">
