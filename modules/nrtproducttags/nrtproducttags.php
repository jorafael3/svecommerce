...
class NrtProductTags extends Module implements WidgetInterface
{
    ...
    {
        return (parent::install() && $this->registerHook('displayProductTags'));
    }
    ...
    public function renderWidget($hookName = null, array $configuration = [])
    {
		...
		$key = $this->name.'|'.$configuration['smarty']->tpl_vars['product']->value['id_product'].'|'.$configuration['smarty']->tpl_vars['product']->value['id_product_attribute'];
