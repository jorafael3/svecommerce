...
class AdminNrtUpgradeController extends ModuleAdminController
{
    ...
    {
        $this->toolbar_title[] = $this->l('Axon - 1 Click Upgrade Akira');
    }
    ...
    {		
        ...
        $config = [
            'phpUpgradeRequired' => $this->module->isPhpUpgradeRequired(),
            ...
            'allowUrlFopenOrCurlIsEnabled' => $this->module->isFOpenOrCurlEnabled(),
    ...
    public function nrtDownload()
    {
        if (!\ConfigurationTest::test_fopen() && !\ConfigurationTest::test_curl()) {
            $this->module->nrtError($this->module->l('You need allow_url_fopen or cURL enabled for automatic download to work.'));
