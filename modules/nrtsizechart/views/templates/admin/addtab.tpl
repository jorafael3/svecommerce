<div id="ModuleNrtSizeChart">
    ...
    <div class="form-group">
		...
		<select name="id_nrtsizechart" id="id_nrtsizechart" class="form-control">
    ...
    <div class="form-group">
        <a class="btn btn-primary" target="_blank" href="{$link->getAdminLink('AdminModules')}&configure=nrtsizechart&addGuide=1">
