...
class NrtSizeChart extends Module implements WidgetInterface
{
    ...
    public function generateCss()
    {
        ...
        if (Shop::getContext() == Shop::CONTEXT_GROUP) {
            $my_file = $this->local_path . 'css/sizechart_g_' . (int) $this->context->shop->getContextShopGroupID() . '.css';
        } elseif (Shop::getContext() == Shop::CONTEXT_SHOP) {
            $my_file = $this->local_path . 'css/sizechart_s_' . (int) $this->context->shop->getContextShopID() . '.css';
        }else{
			$my_file = $this->local_path . 'css/sizechart.css';
		}	
    ...
    public function hookDisplayHeader()
    {
        if ($this->context->controller->php_self == 'product') {
            ...
            if (Shop::getContext() == Shop::CONTEXT_GROUP) {
                $this->context->controller->addCSS(($this->_path) . 'css/sizechart_g_' . (int) $this->context->shop->getContextShopGroupID() . '.css', 'all');
            } elseif (Shop::getContext() == Shop::CONTEXT_SHOP) {
                $this->context->controller->addCSS(($this->_path) . 'css/sizechart_s_' . (int) $this->context->shop->getContextShopID() . '.css', 'all');
            }else{
				$this->context->controller->addCSS(($this->_path) . 'css/sizechart.css', 'all');
			}
