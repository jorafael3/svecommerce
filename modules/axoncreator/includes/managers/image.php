...
class Images_Manager {
	...
	public function get_details( $id, $size, $is_first_time ) {
		if ( ! class_exists( 'Group_Control_Image_Size' ) ) {
			require_once AXON_CREATOR_PATH . '/includes/controls/groups/image-size.php';
		}
	...
	public function __construct() {
		Wp_Helper::add_action( 'wp_ajax_elementor_get_images_details', [ $this, 'get_images_details' ] );
	}
}
