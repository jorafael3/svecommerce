	...
	public static function get_enabled_schemes() {
		if ( null === self::$_enabled_schemes ) {
			...
			foreach ( self::$_schemes_types as $schemes_type => $scheme_class ) {
				if ( 'yes' === Wp_Helper::get_option( 'elementor_disable_' . $schemes_type . '_schemes' ) ) {
					continue;
				}
			 ...
			 */
			$enabled_schemes = Wp_Helper::apply_filters( 'elementor/schemes/enabled_schemes', $enabled_schemes );
