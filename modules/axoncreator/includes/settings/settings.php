				...
				<div class="e-getting-started__box postbox">
					...
					<div class="e-getting-started__content">
						...
						<div class="e-getting-started__actions e-getting-started__content--narrow">
							...
							<a href="https://creator.axonvip.com/getting-started/" target="_blank" class="button button-secondary button-hero"><?php echo Wp_Helper::__( 'Get the Full Guide', 'elementor' ); ?></a>
						</div>
					</div>
				</div>
			</div>
						...
						'fields' => [
							'allow_tracking' => [
								...
								'field_args' => [
									...
									'value' => 'yes',
									'default' => '',
									'sub_desc' => Wp_Helper::__( 'Opt-in to our anonymous plugin data collection and to updates. We guarantee no sensitive data is collected.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://creator.axonvip.com/usage-data-tracking/', Wp_Helper::__( 'Learn more.', 'elementor' ) ),
								],
						...
						'fields' => [
							'css_print_method' => [
								...
								'field_args' => [
									...
									'desc' => '</div><div class="elementor-css-print-method-description" data-value="internal" style="display: none">' . Wp_Helper::__( 'Use internal CSS that is embedded in the head of the page. For troubleshooting server configuration conflicts and managing development environments (recommended).', 'elementor' ) . '</div>' . '<div class="elementor-css-print-method-description" data-value="external" style="display: none">' . Wp_Helper::__( 'Use external CSS files for all generated stylesheets. Choose this setting for better performance.', 'elementor' ),
								],
							],
							'editor_break_lines' => [
