...
<script type="text/template" id="tmpl-elementor-template-library-save-template">
	...
	<div class="elementor-template-library-blank-footer">
		...
		<a class="elementor-template-library-blank-footer-link" href="https://creator.axonvip.com/docs-library/" target="_blank"><?php echo Wp_Helper::__( 'Click here', 'elementor' ); ?></a>
	</div>
</script>
