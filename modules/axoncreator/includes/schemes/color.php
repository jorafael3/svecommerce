...
class Scheme_Color extends Scheme_Base {
	...
	public function get_scheme_titles() {
		return [
			self::COLOR_1 => Wp_Helper::__( 'Primary', 'elementor' ),
			self::COLOR_2 => Wp_Helper::__( 'Secondary', 'elementor' ),
			self::COLOR_3 => Wp_Helper::__( 'Text', 'elementor' ),
			self::COLOR_4 => Wp_Helper::__( 'Accent', 'elementor' ),
		];
	}
