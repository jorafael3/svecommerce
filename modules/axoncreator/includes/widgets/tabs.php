...
class Widget_Tabs extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Tabs', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => Wp_Helper::__( 'Tabs', 'elementor' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => Wp_Helper::__( 'Tab Title', 'elementor' ),
				'placeholder' => Wp_Helper::__( 'Tab Title', 'elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => Wp_Helper::__( 'Tab Content', 'elementor' ),
				'placeholder' => Wp_Helper::__( 'Tab Content', 'elementor' ),
		...
		$this->add_control(
			'tabs',
			[
				'label' => Wp_Helper::__( 'Tabs Items', 'elementor' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => Wp_Helper::__( 'Tab #1', 'elementor' ),
					...
					[
						'tab_title' => Wp_Helper::__( 'Tab #2', 'elementor' ),
						'tab_content' => Wp_Helper::__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'elementor' ),
					],
				],
		...
		$this->add_control(
			'navigation_width',
			[
				'label' => Wp_Helper::__( 'Navigation Width', 'elementor' ),
