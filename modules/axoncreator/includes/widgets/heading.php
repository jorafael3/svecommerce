...
class Widget_Heading extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Heading', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => Wp_Helper::__( 'Add Your Heading Text Here', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'small' => Wp_Helper::__( 'Small', 'elementor' ),
					'medium' => Wp_Helper::__( 'Medium', 'elementor' ),
					'large' => Wp_Helper::__( 'Large', 'elementor' ),
					'xl' => Wp_Helper::__( 'XL', 'elementor' ),
					'xxl' => Wp_Helper::__( 'XXL', 'elementor' ),
				],
			]
		);
