...
class Widget_Google_Maps extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Google Maps', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_map',
			[
				'label' => Wp_Helper::__( 'Map', 'elementor' ),
			]
		);

		$default_address = Wp_Helper::__( 'London Eye, London, United Kingdom', 'elementor' );
		$this->add_control(
			'address',
			[
				'label' => Wp_Helper::__( 'Location', 'elementor' ),
		...
		$this->add_control(
			'zoom',
			[
				'label' => Wp_Helper::__( 'Zoom', 'elementor' ),
	...
	protected function render() {
		...
		printf(
			...
			Wp_Helper::esc_attr( $settings['address'] )
		);
	}
