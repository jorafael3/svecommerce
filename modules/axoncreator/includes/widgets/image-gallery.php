...
class Widget_Image_Gallery extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Image Gallery', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_gallery',
			[
				'label' => Wp_Helper::__( 'Image Gallery', 'elementor' ),
			]
		);
		...
		$this->add_control(
			'gallery_columns',
			[
				'label' => Wp_Helper::__( 'Columns', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'rand' => Wp_Helper::__( 'Random', 'elementor' ),
				],
				'default' => '',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => Wp_Helper::__( 'Images', 'elementor' ),
		...
		$columns_margin = Wp_Helper::is_rtl() ? '0 0 -{{SIZE}}{{UNIT}} -{{SIZE}}{{UNIT}};' : '0 -{{SIZE}}{{UNIT}} -{{SIZE}}{{UNIT}} 0;';
		$columns_padding = Wp_Helper::is_rtl() ? '0 0 {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}};' : '0 {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}} 0;';
		...
		$this->add_control(
			...
			[
				'label' => Wp_Helper::__( 'Display', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => Wp_Helper::__( 'Show', 'elementor' ),
					'none' => Wp_Helper::__( 'Hide', 'elementor' ),
				],
				'selectors' => [
