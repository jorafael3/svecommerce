...
class Widget_Social_Icons extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Social Icons', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_social_icon',
			[
				'label' => Wp_Helper::__( 'Social Icons', 'elementor' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => Wp_Helper::__( 'Official Color', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'rounded',
				'options' => [
					'rounded' => Wp_Helper::__( 'Rounded', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elementor-social-icon svg' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$icon_spacing = Wp_Helper::is_rtl() ? 'margin-left: {{SIZE}}{{UNIT}};' : 'margin-right: {{SIZE}}{{UNIT}};';
		...
		$this->start_controls_section(
			...
			[
				'label' => Wp_Helper::__( 'Icon Hover', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
			...
			foreach ( $settings['social_icon_list'] as $index => $item ) {
				...
				<a <?php echo $this->get_render_attribute_string( $link_key ); ?>>
					...
					if ( $is_new || $migrated ) {
						...
						<i class="<?php echo Wp_Helper::esc_attr( $item['social'] ); ?>"></i>
					<?php } ?>
				</a>
			<?php } ?>
		</div>
