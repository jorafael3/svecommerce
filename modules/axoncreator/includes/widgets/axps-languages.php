 ...
 * @since 1.0.0
 */
class Widget_Axps_Languages extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Languages', 'axiosy' );
	}
	...
	protected function register_styling_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .axps-dropdown-toggle img' => 'width: {{SIZE}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => Wp_Helper::__( 'Image Margin Right', 'axiosy' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'item_icon_size',
				[
					'label' => Wp_Helper::__( 'Image Size', 'axiosy' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
					...
					'selectors' => [
						'{{WRAPPER}} .axps-dropdown-menu img' => 'width: {{SIZE}}{{UNIT}};',
					],
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'body.rtl {{WRAPPER}} .axps-dropdown-menu span' => 'margin-left: {{SIZE}}{{UNIT}}',
					]
				]
			);
	...
	protected function render() {
		...
		echo $this->fetch( 'module:axoncreator/views/templates/widgets/languages.tpl', $params );
	}
