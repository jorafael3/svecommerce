 ...
 * @since 1.0.0
 */
class Widget_Axps_My_Cart extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'Mini Cart', 'elementor' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .btn-canvas .amount',
					'condition' => [
						'button_layout!' => 'icon',
					],
				]
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .cart-nbr' => 'top: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .cart-nbr' => 'right: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .cart-nbr' => 'min-width: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .cart-nbr' => 'font-size: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .cart-nbr' => 'fill: {{VALUE}}; color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .cart-nbr' => 'background-color: {{VALUE}};',
					],
				]
			);
			...
			$this->start_controls_tabs( 'title_tabs_style' );
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'button_price_text_color',
						[
							'label' => Wp_Helper::__( 'Price Text Color', 'elementor' ),
							'type' => Controls_Manager::COLOR,
							'default' => '',
							'selectors' => [
								'{{WRAPPER}} .btn-canvas .amount' => 'fill: {{VALUE}}; color: {{VALUE}};',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'button_hover_price_text_color',
						[
							'label' => Wp_Helper::__( 'Price Text Color', 'elementor' ),
							'type' => Controls_Manager::COLOR,
							'default' => '',
							'selectors' => [
								'{{WRAPPER}} .btn-canvas:hover .amount' => 'fill: {{VALUE}}; color: {{VALUE}};',
							],
						]
					);
	...
	protected function render() {
		...
		if( \Module::isEnabled('nrtshoppingcart') ) {
			...
			$module = \Module::getInstanceByName( 'nrtshoppingcart' );
