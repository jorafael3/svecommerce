 ...
 * @since 1.0.0
 */
class Widget_Axps_My_Wishlist extends Widget_Base {
	...
	public function get_title() {
		return Wp_Helper::__( 'My Wishlist', 'elementor' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .wishlist-nbr' => 'top: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .wishlist-nbr' => 'right: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .wishlist-nbr' => 'min-width: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .wishlist-nbr' => 'font-size: {{SIZE}}{{UNIT}}'
					],
					'separator' => 'before',
				]
			);	
			...
			$this->add_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .wishlist-nbr' => 'fill: {{VALUE}}; color: {{VALUE}};',
					],
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .btn-canvas .wishlist-nbr' => 'background-color: {{VALUE}};',
					],
				]
			);
	...
	protected function render() {
		...
		if( \Module::isEnabled('nrtwishlist') ) {
			...
			echo $this->fetch( 'module:nrtwishlist/views/templates/hook/display-nb.tpl', [ 'icon' => $icon ] );
		}
