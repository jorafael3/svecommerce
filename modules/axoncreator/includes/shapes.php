...
class Shapes {
	...
	public static function get_shape_path( $shape, $is_negative = false ) {
		...
		return AXON_CREATOR_PATH . 'assets/shapes/' . $file_name . '.svg';
	}
	...
	private static function init_shapes() {
		$native_shapes = [
			'mountains' => [
				'title' => Wp_Helper::_x( 'Mountains', 'Shapes', 'elementor' ),
				'has_flip' => true,
			],
			'drops' => [
				'title' => Wp_Helper::_x( 'Drops', 'Shapes', 'elementor' ),
				'has_negative' => true,
				'has_flip' => true,
				'height_only' => true,
			],
			'clouds' => [
				'title' => Wp_Helper::_x( 'Clouds', 'Shapes', 'elementor' ),
				'has_negative' => true,
				'has_flip' => true,
				'height_only' => true,
			],
			'zigzag' => [
				'title' => Wp_Helper::_x( 'Zigzag', 'Shapes', 'elementor' ),
			],
			'pyramids' => [
				'title' => Wp_Helper::_x( 'Pyramids', 'Shapes', 'elementor' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'triangle' => [
				'title' => Wp_Helper::_x( 'Triangle', 'Shapes', 'elementor' ),
				'has_negative' => true,
			],
			'triangle-asymmetrical' => [
				'title' => Wp_Helper::_x( 'Triangle Asymmetrical', 'Shapes', 'elementor' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'tilt' => [
				'title' => Wp_Helper::_x( 'Tilt', 'Shapes', 'elementor' ),
				'has_flip' => true,
				'height_only' => true,
			],
			'opacity-tilt' => [
				'title' => Wp_Helper::_x( 'Tilt Opacity', 'Shapes', 'elementor' ),
				'has_flip' => true,
			],
			'opacity-fan' => [
				'title' => Wp_Helper::_x( 'Fan Opacity', 'Shapes', 'elementor' ),
			],
			'curve' => [
				'title' => Wp_Helper::_x( 'Curve', 'Shapes', 'elementor' ),
				'has_negative' => true,
			],
			'curve-asymmetrical' => [
				'title' => Wp_Helper::_x( 'Curve Asymmetrical', 'Shapes', 'elementor' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'waves' => [
				'title' => Wp_Helper::_x( 'Waves', 'Shapes', 'elementor' ),
				'has_negative' => true,
				'has_flip' => true,
			],
			'wave-brush' => [
				'title' => Wp_Helper::_x( 'Waves Brush', 'Shapes', 'elementor' ),
				'has_flip' => true,
			],
			'waves-pattern' => [
				'title' => Wp_Helper::_x( 'Waves Pattern', 'Shapes', 'elementor' ),
				'has_flip' => true,
			],
			'arrow' => [
				'title' => Wp_Helper::_x( 'Arrow', 'Shapes', 'elementor' ),
				'has_negative' => true,
			],
			'split' => [
				'title' => Wp_Helper::_x( 'Split', 'Shapes', 'elementor' ),
				'has_negative' => true,
			],
			'book' => [
				'title' => Wp_Helper::_x( 'Book', 'Shapes', 'elementor' ),
				'has_negative' => true,
			],
		];
	...
	private static function get_additional_shapes() {
		 ...
		 */
		$additional_shapes = Wp_Helper::apply_filters( 'elementor/shapes/additional_shapes', $additional_shapes );
		return $additional_shapes;
	}
