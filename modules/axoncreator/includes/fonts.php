...
class Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = [
				self::SYSTEM => Wp_Helper::__( 'System', 'elementor' ),
				self::GOOGLE => Wp_Helper::__( 'Google', 'elementor' ),
				self::EARLYACCESS => Wp_Helper::__( 'Google Early Access', 'elementor' ),
			];
			 ...
			 */
			$font_groups = Wp_Helper::apply_filters( 'elementor/fonts/groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			 ...
			 */
			$additional_fonts = Wp_Helper::apply_filters( 'elementor/fonts/additional_fonts', $additional_fonts );
	...
	private static function get_native_fonts() {
		...
		{
			$module = \Module::getInstanceByName('nrtthemecustomizer');
			
			$get_fonts = $module->get_fonts();

			foreach ($get_fonts as $key => $get_font) {			
				$custom_fonts[$get_font['font_name']] = self::SYSTEM;
			}	
		}
		...
		return array_merge( $custom_fonts, $native_fonts );
	}
