	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'hide_in_inner' => true,
				'description' => Wp_Helper::__( 'Stretch the section to the full width of the page using JS.', 'elementor' ) . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://creator.axonvip.com/stretch-section/', Wp_Helper::__( 'Learn more.', 'elementor' ) ),
				'render_type' => 'none',
