	...
	public function enqueue_scripts() {
		...
		$config = [
			...
			'icons' => [
				...
				'goProURL' => Utils::get_pro_link( 'https://creator.axonvip.com/pro/?utm_source=icon-library-go-pro&utm_campaign=gopro&utm_medium=wp-dash' ),
			],
			...
			'elementor_site' => 'https://creator.axonvip.com/about-us/',
			'docs_elementor_site' => 'https://creator.axonvip.com/docs/',
			'help_the_content_url' => 'https://creator.axonvip.com/the-content-missing/',
			'help_right_click_url' => 'https://creator.axonvip.com/meet-right-click/',
			'help_flexbox_bc_url' => 'https://creator.axonvip.com/flexbox-layout-bc/',
			...
			'preview' => [
				'help_preview_error_url' => 'https://creator.axonvip.com/preview-not-loaded/',
				'help_preview_http_error_url' => 'https://creator.axonvip.com/preview-not-loaded/#permissions',
				'help_preview_http_error_500_url' => 'https://creator.axonvip.com/500-error/',
			...
			'i18n' => [		
				...
				'dialog_confirm_enable_fa5' => Wp_Helper::__( 'AxonCreator v1.0 includes an upgrade from Font Awesome 4 to 5. In order to continue using icons, be sure to click "Upgrade".', 'elementor' ) . ' <a href="https://creator.axonvip.com/fontawesome-migration/" target="_blank">' . Wp_Helper::__( 'Learn More', 'elementor' ) . '</a>',
