...
class SmartBlogAllModuleFrontController extends ModuleFrontController
{
    ...
    public function getTemplateVarPage()
    {
        ...
        $body_classes = array(
            ...
            $this->context->shop->theme->getLayoutNameForPage('module-smartblog-all') => true,
    ...
    protected function getAlternativeLangsUrl()
    {
        ...
        foreach ($languages as $lang) {
            $alternativeLangs[$lang['language_code']] = smartblog::GetSmartBlogLink('smartblog', array(), $lang['id_lang']);
        }
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $breadcrumb['links'][] = [
            'title' => Configuration::get('smartblogmetatitle'),
    ...
    {   
		...
		$posts = SmartBlogPost::getAllPost($this->context->language->id, $limit_start, $limit);
		...
		$post_layout = (int)Configuration::get('blog_category_post_layout');
		
		$get_post_layout = (int)Tools::getValue( 'post_layout' );
		
		if( $get_post_layout > 0 && $get_post_layout < 8 ){
			$post_layout = $get_post_layout;
		}

        $this->context->smarty->assign(array(
			'blog_category_post_layout' => $post_layout,
            'posts' => SmartBlogPost::ConvertPost($posts, Configuration::get('blog_category_post_image_type')),
			'header_title' => Configuration::get('smartblogmetatitle'),
        ...
        $this->setTemplate('module:smartblog/views/templates/front/all.tpl');
    }
