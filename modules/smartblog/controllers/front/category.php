...
class SmartBlogCategoryModuleFrontController extends ModuleFrontController
{
    ...
    public function init()
    {
        ...
        switch ($smartblogurlpattern) {
            ...
            case 1:
                ...
                $id_category = $SmartBlog->categoryslug2id($rewrite);
                break;
            case 2:
               $SmartBlog = new smartblog();
    ...
    protected function getAlternativeLangsUrl()
    {
        ...
        foreach ($languages as $lang) {
            $alternativeLangs[$lang['language_code']] = smartblog::GetSmartBlogLink('smartblog_category_rule', array('id_category' => $this->category->id, 'rewrite' => $this->category->link_rewrite), $lang['id_lang']);
        }
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $breadcrumb['links'][] = [
			...
			'url' => smartblog::GetSmartBlogLink('smartblog_category_rule', array('id_category' => $this->category->id, 'rewrite' => $this->category->link_rewrite))
        ];
    ...
    {             
		...
		Hook::exec('actionsbcat', array('id_category' => $this->category->id)); 
