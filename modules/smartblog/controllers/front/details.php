...
class SmartBlogDetailsModuleFrontController extends ModuleFrontController
{
    ...
    public function init()
    {
		...
		$this->context->controller->registerJavascript('modules-smartblog', 'modules/'.$this->module->name.'/js/smartblog.js', ['position' => 'bottom', 'priority' => 150]);
        ...
        switch ($smartblogurlpattern) {
            case 1:
                ...
                $id_post = $SmartBlog->slug2id($rewrite);
                break;
            case 2:
    ...
    protected function getAlternativeLangsUrl()
    {
        ...
        foreach ($languages as $lang) {
            $alternativeLangs[$lang['language_code']] = smartblog::GetSmartBlogLink('smartblog_post_rule', array('id_post' => $this->post->id, 'rewrite' => $this->post->link_rewrite), $lang['id_lang']);
        }
