        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'hint' => $this->l('Upload a feature image from your computer.(.jpg)'),
					'desc' => $this->l('Upload a feature image from your computer.(.jpg)')
                ),
                array(
                    'type' => 'text',
                ...
                array(
                    ...
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->l('Enetr Your Category Rewrite. Use In SEO Friendly URL')
                ),
