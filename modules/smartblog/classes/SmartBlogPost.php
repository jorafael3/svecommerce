...
class SmartBlogPost extends ObjectModel
{
    ...
    public static function getAllPost($id_lang = null, $limit_start, $limit, $id_shop = null)
    {
        if ($id_lang == null) {
            $id_lang = (int) Context::getContext()->language->id;
        }
    ...
    public static function tagsPost($tags, $id_lang = null, $limit_start = 0, $limit = 5)
    {
        ...
        $sql = 'SELECT * FROM ' . _DB_PREFIX_ . 'smart_blog_post p INNER JOIN 
                ...
                AND t.name="' . pSQL($tags) . '" ORDER BY p.id_smart_blog_post DESC LIMIT ' . $limit_start . ',' . $limit;	
    ...
    public static function SmartBlogSearchPost($keyword = NULL, $id_lang = NULL, $limit_start = 0, $limit = 5)
    {
        ...
        $sql = 'SELECT * FROM ' . _DB_PREFIX_ . 'smart_blog_post_lang pl, ' . _DB_PREFIX_ . 'smart_blog_post p INNER JOIN 
                ...
                (pl.meta_title LIKE \'%' . $keyword . '%\' OR
                 ...
                 pl.content LIKE \'%' . $keyword . '%\') ORDER BY p.id_smart_blog_post DESC LIMIT ' . $limit_start . ',' . $limit;
        if (!$posts = Db::getInstance()->executeS($sql)){
            return array();
		}
    ...
    public static function GetPostLatestHome($limit, $imgType = 'home_default', $id_lang = null)
    {
    ...
    public static function GetPostByCategory($id_category, $limit, $imgType = 'home_default', $id_lang = null)
    {
		$limit_start = 0;
        if ($id_lang == null){
            $id_lang = (int) Context::getContext()->language->id;
