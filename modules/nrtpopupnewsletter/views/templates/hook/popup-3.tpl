{if $nrt_ppp.NRT_NEWSLETTER == 1}
    <div id="moda_popupnewsletter" class="modal popup-type-3 popup-text-color-{$nrt_ppp.NRT_NEWSLETTER_TEXT_COLOR}" tabindex="-1" role="dialog"><div class="modal-dialog" role="document">
        <div class="modal-content">
           <button type="button" class="close" data-dismiss="modal" aria-label="{l s='Close' d='Shop.Theme.Global'}">
             <span aria-hidden="true">×</span>
           </button>
			{if $nrt_ppp.NRT_BG == 1 && !empty($nrt_ppp.NRT_BG_IMAGE)}
				<img class="img-responsive" src="{$nrt_ppp.NRT_BG_IMAGE}" alt="" title="">
			{/if}
