{if $nrt_ppp.NRT_NEWSLETTER == 1}
    <div id="moda_popupnewsletter" class="modal popup-type-4 popup-text-color-{$nrt_ppp.NRT_NEWSLETTER_TEXT_COLOR}" tabindex="-1" role="dialog"><div class="modal-dialog" role="document">
