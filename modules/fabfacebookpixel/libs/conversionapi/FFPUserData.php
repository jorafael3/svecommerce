...
require_once('FFPNormalizer.php');

class FFPUserData implements ArrayAccess
{
    /**
    ...
    public function normalize() {
        ...
        $normalized_payload['em'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('em', $this->getEmail()));
        $normalized_payload['ph'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('ph', $this->getPhone()));
        $normalized_payload['ge'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('ge', $this->getGender()));
        $normalized_payload['db'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('db', $this->getDateOfBirth()));
        $normalized_payload['ln'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('ln', $this->getLastName()));
        $normalized_payload['fn'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('fn', $this->getFirstName()));
        $normalized_payload['ct'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('ct', $this->getCity()));
        $normalized_payload['st'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('st', $this->getState()));
        $normalized_payload['zp'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('zp', $this->getZipCode()));
        $normalized_payload['country'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('country', $this->getCountryCode()));
        ...
        $normalized_payload['f5first'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('f5first', $this->getF5first()));
        $normalized_payload['f5last'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('f5last', $this->getF5last()));
        $normalized_payload['fi'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('fi', $this->getFi()));
        $normalized_payload['dobd'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('dobd', $this->getDobd()));
        $normalized_payload['dobm'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('dobm', $this->getDobm()));
        $normalized_payload['doby'] = FFPConversionAPIUtils::hash(FFPNormalizer::normalize('doby', $this->getDoby()));
