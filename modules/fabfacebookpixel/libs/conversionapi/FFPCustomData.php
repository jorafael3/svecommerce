...
class FFPCustomData implements ArrayAccess
{
    /**
    ...
    public function normalize() {
        ...
        $normalized_payload['currency'] =
            FFPNormalizer::normalize('currency', $this->getCurrency());
        ...
        $normalized_payload['delivery_category'] =
            FFPNormalizer::normalize('delivery_category', $this->getDeliveryCategory());
