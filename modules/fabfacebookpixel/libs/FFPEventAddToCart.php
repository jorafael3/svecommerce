...
class FFPEventAddToCart
{
    ...
    public function sendAddToCartContent($productInfo)
    {
        $context = Context::GetContext();

        $eventData = array();
        $eventData['event_name'] = 'AddToCart';
    ...
    {
        $customData = array();
        $customData['value'] =  $productInfo["total_price"];
        $customData['currency'] =  $productInfo["currency_code"];
        $customData['content_ids'] =  array($productInfo["product_id"]);
    ...
    private function getContent($productInfo)
    {
        ...
        $contentData['quantity'] = $productInfo["quantity"];
