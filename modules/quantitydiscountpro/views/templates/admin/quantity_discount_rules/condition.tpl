    ...
    <div class="row">
        ...
        <div class="col-lg-10">
                ...
                <div class="col-lg-11">
                    <select name="condition_id_type[{$condition->id_quantity_discount_rule_group|intval}][{$condition->id_quantity_discount_rule_condition|intval}]">
                        ...
                        <optgroup label="{l s='Customer' mod='quantitydiscountpro'}">
                            ...
                            {if isset($condition->group) && $condition->group && (($condition->group.unselected|@count) + ($condition->group.selected|@count)) > 1}<option value="13" {if isset($condition->id_type) && $condition->id_type|intval == 13}selected="selected"{/if}>{l s='Customer group' mod='quantitydiscountpro'}</option>{/if}
                            ...
                            {if isset($condition->gender) && $condition->gender && (($condition->gender.unselected|@count) + ($condition->gender.selected|@count)) > 0}<option value="21" {if isset($condition->id_type) && $condition->id_type|intval == 21}selected="selected"{/if}>{l s='Customer gender' mod='quantitydiscountpro'}</option>{/if}
                        ...
                        <optgroup label="{l s='Cart/Products' mod='quantitydiscountpro'}">
                            ...
                            {if isset($condition->zone) && $condition->zone && (($condition->zone.unselected|@count) + ($condition->zone.selected|@count)) > 1}<option value="18" {if isset($condition->id_type) && $condition->id_type|intval == 18}selected="selected"{/if}>{l s='Delivery zone' mod='quantitydiscountpro'}</option>{/if}
                            {if isset($condition->country) && $condition->country && (($condition->country.unselected|@count) + ($condition->country.selected|@count)) > 1}<option value="11" {if isset($condition->id_type) && $condition->id_type|intval == 11}selected="selected"{/if}>{l s='Delivery country' mod='quantitydiscountpro'}</option>{/if}
                            {if isset($condition->state) && $condition->state && (($condition->state.unselected|@count) + ($condition->state.selected|@count)) > 1}<option value="24" {if isset($condition->id_type) && $condition->id_type|intval == 24}selected="selected"{/if}>{l s='Delivery state' mod='quantitydiscountpro'}</option>{/if}
                            {if isset($condition->carrier) && $condition->carrier && (($condition->carrier.unselected|@count) + ($condition->carrier.selected|@count)) > 1}<option value="12" {if isset($condition->id_type) && $condition->id_type|intval == 12}selected="selected"{/if}>{l s='Carrier' mod='quantitydiscountpro'}</option>{/if}
                            {if isset($condition->currency) && $condition->currency && (($condition->currency.unselected|@count) + ($condition->currency.selected|@count)) > 1}<option value="22" {if isset($condition->id_type) && $condition->id_type|intval == 22}selected="selected"{/if}>{l s='Currency' mod='quantitydiscountpro'}</option>{/if}
                        </optgroup>
            ...
            *}
            ...
            <div class="form-group condition_type_options_4 condition_type_options_5 condition_type_options_10">
                <div class="col-lg-11 col-lg-offset-1">
                    ...
                    <div class="panel">
                        ...
                        {if isset($condition->product) && $condition->product && (($condition->product.unselected|@count) + ($condition->product.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($condition->attribute) && $condition->attribute && (($condition->attribute.unselected|@count) + ($condition->attribute.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($condition->feature) && $condition->feature && (($condition->feature.unselected|@count) + ($condition->feature.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($condition->category) && $condition->category && (($condition->category.unselected|@count) + ($condition->category.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($condition->supplier) && $condition->supplier && (($condition->supplier.unselected|@count) + ($condition->supplier.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($condition->manufacturer) && $condition->manufacturer && (($condition->manufacturer.unselected|@count) + ($condition->manufacturer.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
            ...
            {if isset($condition->group) && $condition->group && (($condition->group.unselected|@count) + ($condition->group.selected|@count)) > 0}
            ...
            <div class="form-group condition_type_options_26">
                <div class="col-lg-11 col-lg-offset-1">
                    ...
                    <div id="scheduleContainer_{$condition->id_quantity_discount_rule_group|intval}_{$condition->id_quantity_discount_rule_condition|intval}"></div>
                    <script>
                        $('document').ready(function() {
                            var businessHoursManager = $("#scheduleContainer_{$condition->id_quantity_discount_rule_group|intval}_{$condition->id_quantity_discount_rule_condition|intval}").businessHours({
