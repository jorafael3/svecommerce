...
<div id="action_{$action->id_quantity_discount_rule_action|intval}_container" class="col-lg-12 action">
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <div class="form-group" id="action_condition_filters[{$action->id_quantity_discount_rule_action|intval}]">
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="panel">
                        ...
                        {if isset($action->product) && $action->product && (($action->product.unselected|@count) + ($action->product.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($action->attribute) && $action->attribute && (($action->attribute.unselected|@count) + ($action->attribute.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($action->feature) && $action->feature && (($action->feature.unselected|@count) + ($action->feature.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($action->category) && $action->category && (($action->category.unselected|@count) + ($action->category.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($action->supplier) && $action->supplier && (($action->supplier.unselected|@count) + ($action->supplier.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        {if isset($action->manufacturer) && $action->manufacturer && (($action->manufacturer.unselected|@count) + ($action->manufacturer.selected|@count)) > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
            ...
            {if isset($action->carrier) && $action->carrier && (($action->carrier.unselected|@count) + ($action->carrier.selected|@count)) > 0}
