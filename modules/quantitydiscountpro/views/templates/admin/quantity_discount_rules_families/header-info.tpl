...
<div class="panel col-lg-12 quantity-discount-pro">
	<div class="panel-heading">
		{if version_compare($smarty.const._PS_VERSION_,'1.6','<')}<h3>{/if}<!--i class="icon-flag"></i--> {l s='Information' mod='quantitydiscountpro'}{if version_compare($smarty.const._PS_VERSION_,'1.6','<')}</h3>{/if}
	</div>
