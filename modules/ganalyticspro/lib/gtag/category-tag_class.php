...
class BT_GapCategoryTag extends BT_BaseGapFourTaglTags
{
    /**
    ...
    public function __construct(array $aParams)
    {
        ...
        $this->oCategoryName = BT_GapModuleTools::getCategoryName((int)$this->iCategoryId, GAnalyticsPro::$iCurrentLang);
        ...
        if (!empty($this->oCategory)) {
            ...
            $this->aProducts = $this->oCategory->getProducts(GAnalyticsPro::$iCurrentLang, $iPage, $iProductPerPage, $sOrderby, $sOrderway, false, true, false, 1, true, null);
    ...
    {
        $this->sContent_name = str_replace(array('\'', '"'), ' ', $this->oCategoryName);
    }
    ...
    {
        $this->sContent_Category = parent::$sQuote . str_replace(array('\'', '"'), ' ', html_entity_decode(BT_GapModuleTools::getProductPath($this->iCategoryId, GAnalyticsPro::$iCurrentLang))) . parent::$sQuote;
    }
