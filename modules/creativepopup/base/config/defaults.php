...
$cpDefaults = array(
    ...
    'slider' => array(
        ...
        //  'desc' => cp__(
        //     'Enter CSS properties, which will be applied to the popup main '.
        //     'container element to customize it’s appearance.'
        //  )
        // ),
        ...
        'popupSubscribedVisitor' => array(
            'value' => '',
            'name' => cp__('Filter by subscription'),
            'keys' => array('popup_subscribed_visitor', 'subscribed'),
            'desc' => cp__(
        ...
        'popupRepeatDays' => array(
            ...
            'keys' => array('popup_repeat_days', 'repeatDays'),
            'desc' => cp__(
