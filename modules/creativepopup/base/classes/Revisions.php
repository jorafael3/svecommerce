...
class CpRevisions
{
    ...
    public static function count($popupId)
    {
        ...
        $result = $cpdb->getCol($cpdb->prepare(
            "SELECT COUNT(*) FROM {$cpdb->prefix}creativepopup_revisions WHERE popup_id = %d LIMIT 1",
            $popupId
        ));
    ...
    public static function snapshots($popupId)
    {
        ...
        return $cpdb->getResults($cpdb->prepare(
            "SELECT * FROM {$cpdb->prefix}creativepopup_revisions WHERE popup_id = %d ORDER BY id ASC LIMIT 500",
            $popupId
        ));
    }
    ...
    public static function get($revisionId)
    {
        ...
        return $cpdb->getRow($cpdb->prepare(
            "SELECT * FROM {$cpdb->prefix}creativepopup_revisions WHERE id = %d ORDER BY id ASC LIMIT 1",
            $revisionId
        ));
    }
    ...
    public static function last($popupId)
    {
        ...
        return $cpdb->getRow($cpdb->prepare(
            "SELECT * FROM {$cpdb->prefix}creativepopup_revisions WHERE popup_id = %d ORDER BY id DESC LIMIT 1",
            $popupId
        ));
    }
    ...
    public static function shift($popupId)
    {
        ...
        return $cpdb->query($cpdb->prepare(
            "DELETE FROM {$cpdb->prefix}creativepopup_revisions WHERE popup_id = %d ORDER BY id ASC LIMIT 1",
            $popupId
        ));
    }
