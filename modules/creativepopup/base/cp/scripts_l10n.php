...
$cp_l10n = array(
    ...
    'SLEnterCode' => cp__(
        'Please enter a valid Item Purchase Code. For more information, '.
        'please click on the “Where’s my purchase code?” button.'
    ),
    'SLDeactivate' => cp__('Are you sure you want to deactivate this site?'),
    'SLPermissions' => cp__(
        'WARNING: This option controls who can access to this plugin, you can easily lock out yourself by accident. '.
        'Please, make sure that you have entered a valid capability without whitespaces or other invalid characters. '.
        'Do you want to proceed?'
    ),
    'SLJQueryConfirm' => cp__(
        "Do not enable this option unless you're experiencing issues with jQuery on your site. ".
        "This option can easily cause unexpected issues when used incorrectly. Do you want to proceed?"
    ),
    'SLJQueryReminder' => cp__(
        'Do not forget to disable this option later on if it does not help, or if you experience unexpected issues. '.
        'This includes your entire site, not just Creative Popup.'
    ),

    'SLImporting' => cp__('Importing, please wait...'),
    'SLImportError' => cp__(
        'It seems there is a server issue that prevented Creative Popup from importing your selected popup. '.
        'Try to temporarily disable modules to rule out incompatibility issues or contact your hosting provider '.
        'to resolve server configuration problems. In many cases retrying to import the same popup can help.'
    ),
    'SLImportHTTPError' => cp__(
        'It seems there is a server issue that prevented Creative Popup from importing your selected popup. '.
        'Try to temporarily disable modules to rule out incompatibility issues or contact your hosting provider '.
        'to resolve server configuration problems. In many cases retrying to import the same popup can help. '.
        'Your HTTP server thrown the following error: \n\n %s'
    ),

    // Google Fonts
    'GFEmptyList' => cp__("You haven't added any Google Font to your collection yet."),
    'GFEmptyCharset' => cp__(
        'You need to have at least one character set added. Please select another item before removing this one.'
    ),
    ...
    'SBPreviewImagePlaceholder' => cp__('Double click to<br> set image'),
    'SBPreviewMediaPlaceholder' => cp__('Add media or paste embed code'),
    'SBPreviewTextPlaceholder' => cp__('Text Layer'),
    'SBPreviewHTMLPlaceholder' => cp__('HTML Layer'),
    'SBPreviewButtonPlaceholder' => cp__('Button Label'),
    'SBPreviewSlide' => cp__('Preview Page'),
    'SBLayerPreviewMultiSelect' => cp__(
        'Layer Preview is not available in Multiple Selection Mode. Select only one layer to use this feature.'
    ),
    ...
    'SBTransitionApplyOthers' => cp__(
        'Are you sure you want to apply the currently selected transitions and effects on the other pages?'
    ),
    'SBPostFilterWarning' => cp__('No posts were found with the current filters.'),
    'SBSaveError' => cp__(
        'It seems there is a server issue that prevented Creative Popup from saving your work. '.
        'Try to temporarily disable modules to rule out incompatibility issues or '.
        'contact your hosting provider to resolve server configuration problems. '.
        'Your HTTP server thrown the following error: \n\n %s'
    ),
    'SBUnsavedChanges' => cp__(
        'You have unsaved changes on this page. '.
        'Do you want to leave and discard the changes made since your last save?'
    ),
