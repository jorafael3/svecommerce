...
function cp_enqueue_admin_res()
{
    ...
    if (strpos($screen->base, 'cp_page') !== false) {
        ...
        // Popups list page
        if (!empty(${'_GET'}['page']) && ${'_GET'}['page'] != 'transition-builder' &&
            ${'_GET'}['page'] != 'revisions' && empty(${'_GET'}['action'])
        ) {
            cp_enqueue_script(
                'cp-admin-popups',
            ...
            // cp_enqueue_script(
            //     'cp-shuffle',
            //     CP_VIEWS_URL.'/static/shuffle/shuffle.min.js',
            //     array('jquery'),
            //     CP_PLUGIN_VERSION
            // );
        ...
        // Slider & Transition Builder
            ...
            if (!empty(${'_GET'}['page']) &&
                ${'_GET'}['page'] != 'transition-builder' && ${'_GET'}['page'] != 'revisions'
            ) {
