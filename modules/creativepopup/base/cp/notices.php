...
function cp_dependency_notice()
{
    if (version_compare(PHP_VERSION, '5.3.0', '<') || !class_exists('DOMDocument')) {
        ...
        <div class="cp_notice">
            ...
            <p>
                <?php cp_e(
                    'It requires at least PHP 5.3.0 with the following extensions installed: PHP DOM extension, '.
                    'PHP Multibyte String extension. Please contact with your hosting provider to resolve these '.
                    'dependencies, as it will likely prevent Creative Popup from functioning properly.'
                )?>
