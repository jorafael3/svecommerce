...
{if isset($loginizer_data['facebook']['enable']) && $loginizer_data['facebook']['enable'] == 1}
    <li>                
        <a  class="js-social-login button-social-login facebook" 
            href="{url entity='module' name='nrtsociallogin' controller='facebook'}?type=fb" title="Facebook" rel="nofollow">
...
{if isset($loginizer_data['gplus']['enable']) && $loginizer_data['gplus']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login google"   
            href="{url entity='module' name='nrtsociallogin' controller='google'}?type=google" title="Google" rel="nofollow">
...
{if isset($loginizer_data['insta']['enable']) && $loginizer_data['insta']['enable'] == 1}
    <li>                
        <a  class="js-social-login button-social-login instagram" 
            href="{url entity='module' name='nrtsociallogin' controller='instagram'}?type=insta" title="Instagram" rel="nofollow">
...
{if isset($loginizer_data['twitter']['enable']) && $loginizer_data['twitter']['enable'] == 1}
    <li>                
        <a  class="js-social-login button-social-login twitter" 
            href="{url entity='module' name='nrtsociallogin' controller='twitter'}?type=tweet" title="Twitter" rel="nofollow">
...
{if isset($loginizer_data['linked']['enable']) && $loginizer_data['linked']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login linked"  
            href="{url entity='module' name='nrtsociallogin' controller='linkedin'}?type=linked" title="Linkedin" rel="nofollow">
...
{if isset($loginizer_data['yahoo']['enable']) && $loginizer_data['yahoo']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login yahoo"  
            href="{url entity='module' name='nrtsociallogin' controller='ylogin'}?type=yahoo" title="Yahoo" rel="nofollow">
...
{if isset($loginizer_data['live']['enable']) && $loginizer_data['live']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login live"   
            href="{url entity='module' name='nrtsociallogin' controller='live'}?type=live" title="Live" rel="nofollow">
...
{if isset($loginizer_data['foursquare']['enable']) && $loginizer_data['foursquare']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login foursquare"  
            href="{url entity='module' name='nrtsociallogin' controller='foursquare'}?type=foursquare" title="Foursquare" rel="nofollow">
...
{if isset($loginizer_data['amazon']['enable']) && $loginizer_data['amazon']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login amazon"   
            href="{url entity='module' name='nrtsociallogin' controller='amazon'}?type=amazon" title="Amazon" rel="nofollow">
...
{if isset($loginizer_data['pay']['enable']) && $loginizer_data['pay']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login paypal"  
            href="{url entity='module' name='nrtsociallogin' controller='paypal'}?type=pay" title="Paypal" rel="nofollow">
...
{if isset($loginizer_data['github']['enable']) && $loginizer_data['github']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login github"  
            href="{url entity='module' name='nrtsociallogin' controller='github'}?type=github" title="Github" rel="nofollow">
...
{if isset($loginizer_data['disqus']['enable']) && $loginizer_data['disqus']['enable'] == 1} 
    <li>                
        <a 	class="js-social-login button-social-login disqus" 
            href="{url entity='module' name='nrtsociallogin' controller='disqus'}?type=disqus" title="Disqus" rel="nofollow">
...
{/if}
{if isset($loginizer_data['vk']['enable']) && $loginizer_data['vk']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login vk"  
            href="{url entity='module' name='nrtsociallogin' controller='vk'}?type=vk" title="Vk" rel="nofollow">
            <i class="lab la-vk"></i>
            {if isset($loginizer_data['display_button']) && $loginizer_data['display_button'] == 1}
				<span>{l s='Vk' mod='nrtsociallogin'}</span>
            {/if}
        </a>
    </li>
{/if}
{if isset($loginizer_data['wordpress']['enable']) && $loginizer_data['wordpress']['enable'] == 1}
    <li>                
        <a 	class="js-social-login button-social-login wordpress"   
            href="{url entity='module' name='nrtsociallogin' controller='wordpress'}?type=wordpress" title="Wordpress" rel="nofollow">
...
{if isset($loginizer_data['dropbox']['enable']) && $loginizer_data['dropbox']['enable'] == 1}
    <li>                
        <a  class="js-social-login button-social-login dropbox"  
            href="{url entity='module' name='nrtsociallogin' controller='dropbox'}?type=dropbox" title="Dropbox" rel="nofollow">
