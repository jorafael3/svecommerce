    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (preg_match('/^displayProductExtraContent\d*$/', $hookName)) {
            ...
            return array(
                ...
                'logginText' => sprintf($this->l('You need to be %1$slogged in%2$s or %3$screate an account%4$s to give your appreciation of a review.'), '<a href="javascript:void(0)" data-toggle="canvas-widget" data-position="right" data-target="#canvas-my-account"><b>', '</b></a>', '<a href="' . $this->context->link->getPageLink('authentication&create_account=1') . '"><b>', '</b></a>'),
                'id_module' => $this->id,
                'limit' => $data['limit'],
