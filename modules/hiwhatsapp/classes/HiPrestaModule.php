...
class HiPrestaWhatsAppModule
{
    ...
    */
    ...
    public function addTableColumn($table, $column, $type, $after = null)
    {
    ...
    public function getModuleContent($module_name, $free_module = false, $random = '', $show_tab = true)
    {
        ...
        if (!isset($headers[0]) || strpos($headers[0], '404') !== false) {
            ...
            $modules = Tools::jsonDecode(Tools::file_get_contents($url));
        }
