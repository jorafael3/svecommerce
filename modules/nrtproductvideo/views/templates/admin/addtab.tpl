<div id="ModuleNrtProductVideo">
    ...
    <div class="form-group">
    	<div class="row">
			...
			<div class="col-xs-12 col-md-12">
				<select class="form-control" name="id_nrtproductvideo[]" id="id_nrtproductvideo[]" class="form-control">
    ...
    <div class="form-group">
        <a class="btn btn-primary" target="_blank" href="{$link->getAdminLink('AdminModules')}&configure=nrtproductvideo&addProductVideo=1">
