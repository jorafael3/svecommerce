    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                117 => ($this->targetDirs[3].'/modules/sendinblue/translations'),
                118 => ($this->targetDirs[3].'/modules/servientrega_shipping/translations'),
                119 => ($this->targetDirs[3].'/modules/wkpaymentfee/translations'),
                120 => ($this->targetDirs[3].'/modules/salvacero_functions/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                117 => 'datafast',
                118 => 'sendinblue',
                119 => 'servientrega_shipping',
                120 => 'wkpaymentfee',
                121 => 'salvacero_functions',
            ],
