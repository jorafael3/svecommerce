...
/* Smarty version 3.1.47, created on 2024-03-24 13:03:17
  from 'C:\xampp\htdocs\svecommerce\themes\akira\templates\customer\_partials\order-detail-no-return.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_66006ae5a28d88_96303160',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '368538f4113bf1b93d9e81166c84cc352df18ddb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\svecommerce\\themes\\akira\\templates\\customer\\_partials\\order-detail-no-return.tpl',
      1 => 1711210466,
      2 => 'file',
    ),
  ),
...
function content_66006ae5a28d88_96303160 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_130603187666006ae5a14b24_31004065', 'order_products_table');
?>

<?php }
/* {block 'order_products_table'} */
class Block_130603187666006ae5a14b24_31004065 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'order_products_table' => 
  array (
    0 => 'Block_130603187666006ae5a14b24_31004065',
  ),
);
    ...
    <table id="order-products" class="table table-bordered">
      <thead class="thead-default">
        <tr>
          ...
          <th class="text-xs-right"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Quantity','d'=>'Shop.Theme.Catalog'),$_smarty_tpl ) );?>
</th>
          <th class="text-xs-right"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Unit price','d'=>'Shop.Theme.Catalog'),$_smarty_tpl ) );?>
</th>
          <th class="text-xs-right"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Total price','d'=>'Shop.Theme.Catalog'),$_smarty_tpl ) );?>
</th>
        </tr>
      </thead>
      <?php
...
?>
        <tr>
          <td>
            <strong>
              <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['urls']->value['pages']['product'], ENT_QUOTES, 'UTF-8');?>
&id_product=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['id_product'], ENT_QUOTES, 'UTF-8');?>
">
...
<br/>
            ...
            <?php if ((isset($_smarty_tpl->tpl_vars['product']->value['download_link']))) {?>
              <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['download_link'], ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <td class="text-xs-right price"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['price'], ENT_QUOTES, 'UTF-8');?>
</td>
          <td class="text-xs-right price"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['total'], ENT_QUOTES, 'UTF-8');?>
</td>
        </tr>
      <?php
}
...
?>
      <?php if ($_smarty_tpl->tpl_vars['line']->value['value']) {?>
        <div class="order-total row">
          ...
          <div class="col-xs-4 text-xs-right price"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['line']->value['value'], ENT_QUOTES, 'UTF-8');?>
</div>
        </div>
      <?php }?>
    <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    <div class="order-total row">
      ...
      <div class="col-xs-4 text-xs-right price"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value['totals']['total']['value'], ENT_QUOTES, 'UTF-8');?>
</div>
    </div>
  </div>
<?php
